/*
	...
	Att vara synlig för båtarna innebär att båtarna 
	kan se att du önskar handla. De får även veta 
	var du befinner dig så att de kan hitta dig. Att 
	visa din position garanterar inte att båtarna 
	kommer.
